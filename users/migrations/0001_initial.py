# Generated by Django 4.2 on 2023-05-02 18:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('BRAND', 'Brand'), ('INFLUENCER', 'Influencer')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            bases=('users.user',),
            managers=[
                ('influencer', django.db.models.manager.Manager()),
                ('objects', django.contrib.auth.models.UserManager()),
            ],
        ),
    ]
