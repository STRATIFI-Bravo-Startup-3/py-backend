...
InfluencerProfileUpdateView, ProfilePictureUpdateView, BrandProfileView, InfluencerProfileView,
CampaignListCreateView, CampaignRetrieveUpdateDestroyView,
InfluencerPoolView, JobListCreateView, JobRetrieveUpdateDestroyView,
...
urlpatterns = [
    ...
    path('campaigns/<int:pk>/', CampaignRetrieveUpdateDestroyView.as_view(), name='campaigns_retrieve_update_destroy'),
    path('jobs/', JobListCreateView.as_view(), name='jobs_list_create'),
    path('jobs/<int:pk>/', JobRetrieveUpdateDestroyView.as_view(), name='jobs_retrieve_update_destroy'),
    path('campaigns/<int:campaign_id>/influencer-pool/', InfluencerPoolView.as_view(), name='influencer_pool_list'),
