...
class WithdrawView(APIView):
    ...
    def post(self, request):
        ...
        return Response(
            {"success": "Withdrawal successful."}, status=status.HTTP_200_OK
        )
...
class BalanceCheck(APIView):
    ...
    def get(self, request):
        ...
        return Response(
            {"wallet": serializer.data, "balance": balance}, status=status.HTTP_200_OK
        )
...
class DepositFunds(APIView):
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            wallet.save()
            return Response(
                {"message": "Deposit successful"}, status=status.HTTP_200_OK
            )
